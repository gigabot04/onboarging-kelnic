...
/* harmony import */ var _modules_init_range_slider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-range-slider */ "./js/modules/init-range-slider.js");
/* harmony import */ var _modules_init_scroll_top__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-scroll-top */ "./js/modules/init-scroll-top.js");
/* harmony import */ var _modules_init_backend__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-backend */ "./js/modules/init-backend.js");
/* harmony import */ var _modules_init_add_list__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-add-list */ "./js/modules/init-add-list.js");
/* harmony import */ var _vendor_testInstruments__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./vendor/testInstruments */ "./js/vendor/testInstruments.js");
...
Object(_modules_init_range_slider__WEBPACK_IMPORTED_MODULE_2__["initRangeSlider"])();
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_init_scroll_top__WEBPACK_IMPORTED_MODULE_3__["initScrollUp"])(); // Modules
  // ---------------------------------
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_init_backend__WEBPACK_IMPORTED_MODULE_4__["sendReq"])().then(function (data) {
      return Object(_modules_init_add_list__WEBPACK_IMPORTED_MODULE_5__["loadData"])(data);
    }).catch(function (err) {
      return console.log(err);
    });
    Object(_vendor_testInstruments__WEBPACK_IMPORTED_MODULE_6__["testInstruments"])();
  });
}); // ---------------------------------
...
var item = document.querySelector('#table__item').content;
var tableBody = document.querySelector('.table__body');
var loadBtn = document.querySelector('.table__load-btn');
var btn = document.querySelectorAll('.table__btn');
var fullList = [];
var hiddenList = [];
var sortList = [];
...
var loadData = function loadData(lists) {
  fullList.push.apply(fullList, _toConsumableArray(lists));
  hiddenList.push.apply(hiddenList, _toConsumableArray(fullList.splice(5, fullList.length)));
  sortList = sortList.concat(fullList);
  add(fullList);
};

var add = function add(lists) {
  var fragmentComments = document.createDocumentFragment();
  lists.forEach(function (list) {
    var copyComment = item.cloneNode(true);
...
var loadComment = function loadComment() {
  var splice = hiddenList.splice(0, 5);
...
var initRangeSlider = function initRangeSlider() {
  var slider = document.querySelector('#form-slider1');
  ...
  var slider2 = document.querySelector('#form-slider2');
  _vendor_nouislider__WEBPACK_IMPORTED_MODULE_0___default.a.create(slider2, {
    start: [0, 250],
    connect: true,
    step: 1,
    range: {
  ...
  var priceNum1 = document.querySelector('#price-flat1');
  var priceNum2 = document.querySelector('#price-flat2');
  var priceNums1 = [priceNum1, priceNum2];
  var squaresNum1 = document.querySelector('#squares-flat1');
  var squaresNum2 = document.querySelector('#squares-flat2');
  var squaresNums1 = [squaresNum1, squaresNum2];
  var resetBtn = document.querySelector('.form button[type="reset"]');
  var inputCheckbox = document.querySelectorAll('.form input[type="checkbox"]');
  priceNum1.addEventListener('change', function () {
    slider.noUiSlider.set([priceNum1.value, priceNum2.value]);
  });
  priceNum2.addEventListener('change', function () {
    slider.noUiSlider.set([priceNum1.value, priceNum2.value]);
  });
  squaresNum1.addEventListener('change', function () {
    slider2.noUiSlider.set([squaresNum1.value, squaresNum2.value]);
  });
  squaresNum2.addEventListener('change', function () {
    slider2.noUiSlider.set([squaresNum1.value, squaresNum2.value]);
  });
...
/***/ "./js/modules/init-scroll-top.js":
/*!***************************************!*\
  !*** ./js/modules/init-scroll-top.js ***!
  \***************************************/
/*! exports provided: initScrollUp */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initScrollUp", function() { return initScrollUp; });
